...
function Header() {
  const { getQty } = useContext(UserContext);

  console.log('Cart Quantity:', getQty);
            ...
            <div className="col-md-8 clearfix">
              <div className="shop-menu clearfix pull-right">
                <ul className="nav navbar-nav">
                  ...
                  <li><a href="http://localhost:3000/product/cart"><i className="fa fa-shopping-cart"></i> Cart {localStorage.getItem("tongQty")}</a></li>
                  <li><a href="http://localhost:3000/member/login"><i className="fa fa-lock"></i> Login</a></li>
                </ul>
              </div>
            </div>
          </div>
